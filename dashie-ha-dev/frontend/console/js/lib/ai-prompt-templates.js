...
`;
    ...
    const INQUIRY_WIKIPEDIA = `# Inquiry Context: Wikipedia Lookup
...
`;
    ...
    const INQUIRY_PLACE_SEARCH = `# Inquiry Context: Place Search
...
`;
    ...
    const INQUIRY_DIRECTIONS = `# Inquiry Context: Distance and Travel Time
